...
<div class="bg0 m-t-25 p-b-140">
				...
				<div class="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm">
					...
					<div class="filter-col2 p-r-15 p-b-27">
						...
						<div class="flex-w p-t-4 m-r--5">
							<input class="mtext-107 cl2 size-114 plh2 p-r-15" type="number" name="min-price"
								placeholder="Min Price">
							<input class="mtext-107 cl2 size-114 plh2 p-r-15" type="number" name="max-price"
	...
	<div class="flex-c-m flex-w w-full p-t-45">
		<a href="load-more" class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04">
			Load More
		</a>
	</div>
</div>
