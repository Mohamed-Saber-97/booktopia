...
class BuyerProductControllerTest {
    ...
    void getBuyerInterestedProducts_withValidId_shouldReturnProductDtos() {
        ...
        List<ProductDto> products = Arrays.asList(
                new ProductDto(1L, "Product 1", "Description 1", "Author 1", "ISBN001", LocalDate.now(), 1L, BigDecimal.valueOf(100.00), 10, "image1.png"),
                new ProductDto(2L, "Product 2", "Description 2", "Author 2", "ISBN002", LocalDate.now(), 2L, BigDecimal.valueOf(150.00), 5, "image2.png")
        );
