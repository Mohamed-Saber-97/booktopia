...
class OrderControllerTest {
    ...
    void testGetOrderById() {
        ...
        OrderDto orderDto = new OrderDto(orderId, "UNSHIPPED", 1L, LocalDate.now(), 1);
    ...
    void testGetOrdersByBuyerId() {
        ...
        OrderDto orderDto = new OrderDto(1L, "UNSHIPPED", buyerId, LocalDate.now(), 1);
    ...
    void testCreateOrder() {
        ...
        OrderDto savedOrderDto = new OrderDto(1L, "UNSHIPPED", buyerId, LocalDate.now(), 1);
