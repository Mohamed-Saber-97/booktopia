                ...
                <div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
                    <form>
                        ...
                        <div class="bor8 m-b-30">
                            <input class="stext-111 cl2 plh3 size-120 p-lr-28 p-tb-25" type="text" name="name"
                                placeholder="Full name">
                        </div>

                        <div class="bor8 m-b-30">
                              <input class="stext-111 cl2 plh3 size-120 p-lr-28 p-tb-25" type="date" name="date"
                                                        placeholder="Date of birth">
                        </div>


                        <div class="bor8 m-b-30">
                            <input class="stext-111 cl2 plh3 size-120 p-lr-28 p-tb-25" type="password" name="pass"
                                                            placeholder="Password">
                        </div>

                        <div class="bor8 m-b-30">
                            <input class="stext-111 cl2 plh3 size-120 p-lr-28 p-tb-25" type="text" name="job"
                                           placeholder="Job">
                            </div>

                        <div class="bor8 m-b-30">
                            <input class="stext-111 cl2 plh3 size-120 p-lr-28 p-tb-25" type="text" name="phone"
                                                                   placeholder="Phone">
                        </div>
                        <div class="bor8 m-b-30">
                            <input class="stext-111 cl2 plh3 size-120 p-lr-28 p-tb-25" type="text" name="address"
                                                              placeholder="Address">
                        </div>
