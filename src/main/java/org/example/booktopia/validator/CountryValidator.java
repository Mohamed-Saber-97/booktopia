...
public class CountryValidator {
    ...
    public static boolean isValid(String... countries) {
        return Arrays.stream(countries).allMatch(countrySet::contains);
    }
}